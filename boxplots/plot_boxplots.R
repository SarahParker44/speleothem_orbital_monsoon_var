...
p1a <- ggplot(filter(dat_all, region == "ISM"), aes(x = dat_type, y = val, group = interaction(time_slice, dat_type), fill = dat_type)) +
...
pdf("PhD/monsoon_paper/figs/boxplot_fig_test.pdf", width = 3.54, height = 5.91/3)
print(plot_1)
dev.off()
...
p2a <- ggplot(filter(dat_all, region == "EAM"), aes(x = dat_type, y = val, group = interaction(time_slice, dat_type), fill = dat_type)) +
  geom_boxplot(outlier.colour = "grey", lwd = 0.1, outlier.size = 0.5) + scale_fill_manual(values = palette) +
...
p3a <- ggplot(filter(dat_all, region == "IAM"), aes(x = dat_type, y = val, group = interaction(time_slice, dat_type), fill = dat_type)) +
  geom_boxplot(outlier.colour = "grey", lwd = 0.1, outlier.size = 0.5) + scale_fill_manual(values = palette) +
...
pdf("PhD/monsoon_paper/figs/boxplot_fig_v2.pdf", width = 3.54, height = 5.91)
